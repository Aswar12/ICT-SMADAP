...
<head>
  ...
  <link href="{{ asset('style/assets/img/apple-touch-icon.png')}}assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="{{ asset('style/assets/vendor/venobox/venobox.css')}}" rel="stylesheet">
  <link href="{{ asset('style/assets/vendor/owl.carousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">ICT SMAN 2 PANGKEP</a></h1>
